...
# Generate joint samples for x and y axes (check point)
...
for i in range(client_num):
    x_coord=np.random.randint(20,80)
    y_coord=np.random.randint(20,80)
...
"""
1 group
group_indices = [((0, 100), (0, 100))]  # Entire grid as one group

# Center for the single group (center of the grid)
centers = [(50, 50)]  # Center of the entire grid
"""
...
"""
# Dividing the 100x100 grid into 9 groups of approximately 33x33 size
group_indices_9 = [
    ((0, 33), (0, 33)),      # Top-left quadrant
    ((0, 33), (33, 66)),     # Top-center quadrant
    ((0, 33), (66, 100)),    # Top-right quadrant
    ((33, 66), (0, 33)),     # Middle-left quadrant
    ((33, 66), (33, 66)),    # Middle-center quadrant
    ((33, 66), (66, 100)),   # Middle-right quadrant
    ((66, 100), (0, 33)),    # Bottom-left quadrant
    ((66, 100), (33, 66)),   # Bottom-center quadrant
    ((66, 100), (66, 100))   # Bottom-right quadrant
]

# Calculating the centers of each group
centers = [
    (16, 16),     # Top-left quadrant center
    (16, 49),     # Top-center quadrant center
    (16, 83),     # Top-right quadrant center
    (49, 16),     # Middle-left quadrant center
    (49, 49),     # Middle-center quadrant center
    (49, 83),     # Middle-right quadrant center
    (83, 16),     # Bottom-left quadrant center
    (83, 49),     # Bottom-center quadrant center
    (83, 83)      # Bottom-right quadrant center
]
"""
"""
#dividing 16 group
group_indices = [
    ...
    ((25, 50), (25, 50)),    # Group 6
    ((25, 50), (50, 75)),    # Group 7
    ((25, 50), (75, 100)),   # Group 8
    ((50, 75), (0, 25)),     # Group 9
    ((50, 75), (25, 50)),    # Group 10
    ((50, 75), (50, 75)),    # Group 11
    ((50, 75), (75, 100)),   # Group 12
    ((75, 100), (0, 25)),    # Group 13
    ((75, 100), (25, 50)),   # Group 14
    ((75, 100), (50, 75)),   # Group 15
    ((75, 100), (75, 100))   # Group 16
]

# Calculating the centers of each group
centers = [
    (12, 12),     # Group 1 center
    (12, 37),     # Group 2 center
    (12, 62),     # Group 3 center
    (12, 87),     # Group 4 center
    (37, 12),     # Group 5 center
    (37, 37),     # Group 6 center
    (37, 62),     # Group 7 center
    (37, 87),     # Group 8 center
    (62, 12),     # Group 9 center
    (62, 37),     # Group 10 center
    (62, 62),     # Group 11 center
    (62, 87),     # Group 12 center
    (87, 12),     # Group 13 center
    (87, 37),     # Group 14 center
    (87, 62),     # Group 15 center
    (87, 87)      # Group 16 center
]
"""

colors = ['red', 'blue', 'green', 'orange', 'purple', 'cyan', 'magenta', 'yellow', 'brown',
          'lime', 'teal', 'olive', 'pink', 'lavender', 'tan', 'cyan']
plt.figure(figsize=(8, 6))

# Scatter plot of client coordinates for 16 groups
...
plt.title('Coordinates of 50 Clients with Different Pixel Colors (16 Groups)')
...
while rounds < max_rounds:
    ...
    for i, group_idx in enumerate(group_indices):
        ...
        if len(group_clients) > 0:  # Only train if there are selected pixels within the group
            ...
            round_accuracy.append(0.0)  # Append 0 accuracy for groups with no selected pixels
...
with open('accuracy_progressT4.csv', mode='w', newline='') as file:
...
plt.figure(figsize=(8, 6))
plt.plot(range(1, rounds + 1), accuracy_progress, marker='o',label="9groups")
